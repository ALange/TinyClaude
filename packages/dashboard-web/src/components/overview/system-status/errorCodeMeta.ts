import type { RateLimitReason } from "@tinyclaude/types";
...
> = {
	...
	upstream_429_no_reset_probe_cooldown: {
		...
		suggestion:
			"Cooldown defaults to 60s. Set `TINYCLAUDE_DEFAULT_COOLDOWN_NO_RESET_MS` in your environment to change it.",
		severity: "warning",
	},
