...
import { HttpError } from "@tinyclaude/http-common";
...
const LazyCompressionTab = lazy(() =>
	import("./components/CompressionTab").then((module) => ({
		default: module.CompressionTab,
	})),
);
		...
		const baseRoutes = [
			{
				...
				subtitle: "Monitor your tinyclaude performance and usage",
			},
			{
				path: "/analytics",
				element: (
			...
			},
			{
				...
				title: "Compression",
				subtitle: "Tool-result compression savings and cache alignment health",
			},
			{
				path: "/requests",
				element: <RequestsTab />,
