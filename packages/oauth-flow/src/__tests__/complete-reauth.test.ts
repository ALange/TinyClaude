...
import type { OAuthProviderConfig, OAuthTokens } from "@tinyclaude/providers";
...
// ---------------------------------------------------------------------------
// Mock @tinyclaude/providers so no real OAuth calls go out.
...
mock.module("@tinyclaude/providers", () => ({
