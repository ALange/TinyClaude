import { agentRegistry } from "@tinyclaude/agents";
...
import type { AgentTool, AllowedModel, APIContext } from "@tinyclaude/types";
import { TOOL_PRESETS } from "@tinyclaude/types";
import {
