...
import {
	...
	workspacePersistence,
} from "@tinyclaude/agents";
import { LATEST_SONNET_MODEL } from "@tinyclaude/core";
import { DatabaseFactory, type DatabaseOperations } from "@tinyclaude/database";
...
// state to the real `~/.tinyclaude/workspaces.json`. Redirect it to an
