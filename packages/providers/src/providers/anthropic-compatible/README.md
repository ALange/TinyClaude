...
```typescript
import { AnthropicCompatibleProvider } from "@tinyclaude/providers";
```
...
```typescript
import { createAnthropicCompatibleProvider } from "@tinyclaude/providers";
...
```typescript
import { createProviderForService } from "@tinyclaude/providers";
...
```typescript
import { PresetProviders } from "@tinyclaude/providers";
...
```typescript
import { registerProvider } from "@tinyclaude/providers";
import { createAnthropicCompatibleProvider } from "@tinyclaude/providers";
...
import { listProviders } from "@tinyclaude/providers";
...
```typescript
// Old z.ai setup
import { ZaiProvider } from "@tinyclaude/providers";
...
// Old minimax setup
import { MinimaxProvider } from "@tinyclaude/providers";
