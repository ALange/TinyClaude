...
tinyclaude now supports optional API authentication that allows you to secure your proxy endpoint with API keys. When API keys are configured, all requests to the proxy API must include a valid API key.
...
tinyclaude --generate-api-key "Production App"
...
tinyclaude --generate-api-key "My App"

# Generate multiple keys for different environments
tinyclaude --generate-api-key "Production"
tinyclaude --generate-api-key "Development"
tinyclaude --generate-api-key "Testing"
```

### List API Keys
```bash
# List all API keys with status
tinyclaude --list-api-keys
...
tinyclaude --disable-api-key "Production"

# Enable a disabled API key
tinyclaude --enable-api-key "Production"

# Delete an API key permanently
tinyclaude --delete-api-key "Production"
```

## 🌐 Web Dashboard

### Access the API Keys Interface
1. Navigate to your tinyclaude dashboard (default: http://localhost:8080)
...
tinyclaude --generate-api-key "Production-Web-App"
tinyclaude --generate-api-key "Production-API"

# Development environment
tinyclaude --generate-api-key "Dev-Local"
tinyclaude --generate-api-key "Dev-Testing"

# Staging environment
tinyclaude --generate-api-key "Staging-App"
```

### **Access Control**
```bash
# Create keys with limited scope
tinyclaude --generate-api-key "Read-Only-Integration"
tinyclaude --generate-api-key "Write-Access-Service"
```
...
2. **Generate First API Key**:
   ```bash
   tinyclaude --generate-api-key "First Key"
   ```
...
tail -f ~/.config/tinyclaude/tinyclaude.log
```
...
# API Key Commands
tinyclaude --generate-api-key <name>
tinyclaude --list-api-keys
tinyclaude --disable-api-key <name>
tinyclaude --enable-api-key <name>
tinyclaude --delete-api-key <name>
```
...
PROD_KEY=$(tinyclaude --generate-api-key "production" | grep "Key:" | awk '{print $2}')
STAGING_KEY=$(tinyclaude --generate-api-key "staging" | grep "Key:" | awk '{print $2}')
...
- **Documentation**: [Full Documentation](https://github.com/your-repo/tinyclaude)
- **Issues**: [GitHub Issues](https://github.com/your-repo/tinyclaude/issues)
- **Discussions**: [GitHub Discussions](https://github.com/your-repo/tinyclaude/discussions)
- **Community**: [Join our Discord](https://discord.gg/tinyclaude)

---

*API authentication is optional. Your tinyclaude instance will work exactly as before until you generate your first API key.*