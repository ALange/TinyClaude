...
This document tracks changes to the Anthropic API responses that affect tinyclaude.
...
### How tinyclaude Handles API Changes
...
sqlite3 ~/.config/tinyclaude/tinyclaude.db "SELECT access_token FROM accounts WHERE name = 'claude' LIMIT 1;"
