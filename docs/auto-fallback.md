...
This guide covers the auto-fallback feature in tinyclaude, which allows automatic switching back to higher priority accounts when their usage windows reset.
...
tinyclaude --add-account primary --mode max --priority 0
tinyclaude --add-account secondary --mode max --priority 10
...
tinyclaude --add-account primary --mode max --priority 0 || true
tinyclaude --add-account secondary --mode max --priority 10 || true
tinyclaude --add-account backup --mode console --priority 50 || true
...
tinyclaude --add-account high-priority --mode console --priority 0

# Lower priority accounts
tinyclaude --add-account medium-priority --mode max --priority 10
tinyclaude --add-account low-priority --mode max --priority 20
...
tinyclaude --add-account premium --mode max --priority 0

# Medium priority account (good performance, priority 10)
tinyclaude --add-account standard --mode max --priority 10

# Low priority account (lower performance, priority 20)
tinyclaude --add-account basic --mode console --priority 20
...
tinyclaude --add-account business --mode max --priority 0

# Medium priority account (priority 10)
tinyclaude --add-account after-hours --mode max --priority 10

# Low priority account (priority 20)
tinyclaude --add-account weekend --mode console --priority 20
...
tail -f ~/.local/share/tinyclaude/logs/tinyclaude.log | grep -E "(Auto-fallback|SessionStrategy|Account)"
```
...
#!/bin/bash
while true; do
  if tail -n 10 ~/.local/share/tinyclaude/logs/tinyclaude.log | grep -q "Auto-fallback"; then
