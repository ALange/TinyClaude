...
This guide covers the important changes and migration steps when upgrading from tinyclaude version 2.x to version 3.x.
...
Start tinyclaude normally. The migration will run automatically:
...
3. Consult the [GitHub Issues](https://github.com/ALange/TinyClaude/issues) page
