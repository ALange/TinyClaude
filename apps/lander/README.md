# tinyclaude Landing Page

Static landing page for tinyclaude - showcasing how simple it is to never hit rate limits again.
...
That single `bun run tinyclaude` command gives you:
...
2. Deploy:
   ...
   cd apps/lander
   bun run build
   wrangler pages deploy dist --project-name=tinyclaude-landing
   ```

## Features

- Dark theme matching tinyclaude dashboard
- Mobile responsive
- Security headers configured
- Optimized for performance
- Static HTML/CSS (no JavaScript framework)
- Real screenshots from actual tinyclaude usage