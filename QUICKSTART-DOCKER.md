...
Published everywhere:
  ✓ npm: tinyclaude@1.2.28
  ✓ GitHub Releases: v1.2.28 with binaries
  ✓ Docker: ghcr.io/alange/tinyclaude:1.2.28 ← NEW!
```
...
# Run it
docker run -p 8080:8080 -v tinyclaude-data:/data tinyclaude:local
...
2. **GitHub Actions**:
   - Binaries: https://github.com/ALange/TinyClaude/actions/workflows/release.yml
   - Docker: https://github.com/ALange/TinyClaude/actions/workflows/docker-publish.yml

3. **Results**:
   - NPM: https://www.npmjs.com/package/tinyclaude
   - Releases: https://github.com/ALange/TinyClaude/releases
   - Docker: https://github.com/ALange/TinyClaude/pkgs/container/tinyclaude
...
```bash
ghcr.io/alange/tinyclaude:1.2.28  # Specific version
ghcr.io/alange/tinyclaude:1.2     # Minor version
ghcr.io/alange/tinyclaude:1       # Major version
ghcr.io/alange/tinyclaude:latest  # Latest release
```
...
- https://github.com/ALange/TinyClaude/actions/workflows/docker-publish.yml
...
1. Go to https://github.com/ALange/TinyClaude/pkgs/container/tinyclaude
...
```bash
docker pull ghcr.io/alange/tinyclaude:latest
docker inspect ghcr.io/alange/tinyclaude:latest | jq '.[0].Config.Labels'
```
...
```json
{
  ...
  "org.opencontainers.image.source": "https://github.com/ALange/TinyClaude"
}
```
...
3. **Test the image**: `docker pull ghcr.io/alange/tinyclaude:latest`
