...
This document explains the complete automated build and publish pipeline for tinyclaude.
...
### NPM Package
- Published to: https://www.npmjs.com/package/tinyclaude
...
- Pull with: `docker pull ghcr.io/alange/tinyclaude:latest`
...
│    ├─ linux/amd64                                               │
│    └─ linux/arm64                                               │
│ 7. Push to ghcr.io/alange/tinyclaude                       │
│    ├─ latest (from main)                                        │
│    ├─ v1.2.28 (from tag)                                        │
│    ├─ 1.2 (from tag)                                            │
│    └─ 1 (from tag)                                              │
...
After the automated pipeline completes, users can install tinyclaude in multiple ways:
...
```bash
# Pull and run
docker pull ghcr.io/alange/tinyclaude:latest
docker run -p 8080:8080 ghcr.io/alange/tinyclaude:latest
...
- Check publish status at: https://www.npmjs.com/package/tinyclaude

### GitHub Actions
- Multi-arch binaries: https://github.com/ALange/TinyClaude/actions/workflows/release.yml
- Docker images: https://github.com/ALange/TinyClaude/actions/workflows/docker-publish.yml
- Releases: https://github.com/ALange/TinyClaude/releases

### Docker Images
- Registry: https://github.com/ALange/TinyClaude/pkgs/container/tinyclaude
- Pull: `docker pull ghcr.io/alange/tinyclaude:latest`
...
1. Check workflow runs: https://github.com/ALange/TinyClaude/actions
...
### Docker build fails
1. Check Docker workflow: https://github.com/ALange/TinyClaude/actions/workflows/docker-publish.yml
2. Common issues:
...
```bash
# Single platform
docker build -t tinyclaude:local .

# Multi-platform (requires buildx)
docker buildx build \
  --platform linux/amd64,linux/arm64 \
  --tag ghcr.io/alange/tinyclaude:test \
  .
```
...
- URL: `ghcr.io/alange/tinyclaude`

### Optional: Docker Hub Publishing

If you also want to publish to Docker Hub, add these repository secrets:

1. Go to: https://github.com/ALange/TinyClaude/settings/secrets/actions
